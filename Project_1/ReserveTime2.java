...
public class ReserveTime2 extends JPanel {
   ...
   public ReserveTime2(FlightSearchModify gparent) {
      this.add(p);
      p.add(pNorth, "North");
      
      date = new JLabel(gparent.arrivalDate+"     ");
      date.setFont(menuFont);
      start = new JLabel(gparent.arrivalPlace);
      start.setFont(menuFont);
      none = new JLabel("--------------  ");
      arrive = new JLabel(gparent.departurePlace);
    ...
    //시간표
      if( gparent.arrivalPlace.equals("일본")&&gparent.departurePlace.equals("인천")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if( gparent.arrivalPlace.equals("독일")&&gparent.departurePlace.equals("인천")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
          l2 = new JLabel("                   "+"11시간 10분");
          p3c.add(l2);
          l3 = new JLabel("");
          p3c.add(l3);
          l4 = new JLabel("                   "+"13:20");
      ...
      else if(gparent.arrivalPlace.equals("미국")&&gparent.departurePlace.equals("인천")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if(gparent.arrivalPlace.equals("중국")&&gparent.departurePlace.equals("인천")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if((gparent.arrivalPlace.equals("일본")&&
    		  gparent.departurePlace.equals("부산") ||
    		  gparent.departurePlace.equals("김포"))  ) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else  if(gparent.departurePlace.equals("제주") && gparent.arrivalPlace.equals("일본")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else  if( gparent.arrivalPlace.equals("제주")&& gparent.departurePlace.equals("인천")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if(gparent.arrivalPlace.equals("일본")&&(gparent.departurePlace.equals("부산") || 
    		  gparent.departurePlace.equals("김포")) ) {
    	  l1 = new JLabel("");
          p3c.add(l1);
          l2 = new JLabel("                   "+"2시간 00분");
      ...
      else if( gparent.arrivalPlace.equals("제주")&&gparent.departurePlace.equals("부산")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if( gparent.arrivalPlace.equals("제주")&&gparent.departurePlace.equals("김포")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
          l2 = new JLabel("                   "+"1시간 20분");
          p3c.add(l2);
      ...
      else if(gparent.arrivalPlace.equals("미국")&&gparent.departurePlace.equals("김포")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if(gparent.arrivalPlace.equals("미국")&&gparent.departurePlace.equals("부산")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if(gparent.arrivalPlace.equals("중국")&&gparent.departurePlace.equals("김포")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
      ...
      else if(gparent.arrivalPlace.equals("중국")&&gparent.departurePlace.equals("부산")) {
    	  l1 = new JLabel("");
          p3c.add(l1);
